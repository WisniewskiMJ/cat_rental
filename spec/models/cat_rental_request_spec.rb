...
RSpec.describe CatRentalRequest, type: :model do
  ...
  describe 'validations' do
    ...
    it "should validate end_date not earlier than start_date" do
    ...
    it "should validate start_date not in the past" do
      request.start_date = Date.today.last_week
      request.valid?
      expect(request.errors[:start_date]).to eq(['can not be in the past'])
    end
  
     it "should validate request does not overlap with approved request" do
  ...
  describe 'class methods' do
    ...
    describe 'approve!' do
      context 'status is not :pending' do
        it 'should raise error if status is not pending' do
      ...
      context 'status is pending' do
        it 'should deny other overlapping requests' do
          request.save
        ...
        it 'should change request status to approved' do
          request.approve!
    ...
    describe 'deny!' do
      it 'should change request status to denied' do
        request.deny!
